...
// ****************************************************
// Routines:
// SplineShaft(d=20,l=30,nSplines=6,Spline_w=30,Hole=6,Key=false);
// SplineHole(d=20,l=20,nSplines=6,Spline_w=30,Gap=IDXtra,Key=false);
//
// for test fitting
// SplineHoleTest();
...
module SplineShaft(d=20,l=50,nSplines=6,Spline_w=10,Hole=6,Key=false){
	Rad=1;
	Small_OD=d-Rad*4.25;
...
module SplineHole(d=20,l=20,nSplines=6,Spline_w=30,Gap=IDXtra,Key=false){
	Rad=1;
	Small_OD=d-Rad*4.25;
	Spline_y=d*3.14/(360/Spline_w);
	Tan_a=360/((d-Rad*2)*3.14/(Spline_y-Rad*2));
